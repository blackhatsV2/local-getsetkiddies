-- phpMyAdmin SQL Dump fixed for Aiven MySQL
-- Every table must have a Primary Key defined inline.
...
CREATE TABLE `geofences` (
  ...
  CONSTRAINT `fk_child_geofence` FOREIGN KEY (`child_id`) REFERENCES `registered_children` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `locations` (
  ...
  CONSTRAINT `fk_child_location` FOREIGN KEY (`child_id`) REFERENCES `registered_children` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
